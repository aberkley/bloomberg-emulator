...
import sra_london.bloomberg_emulator.MessageIterator;
import sra_london.bloomberg_emulator.Subscription;
...
public class MarketEvent extends Event
{
    ...
    {
    	return sra_london.bloomberg_emulator.RandomDataGenerator.getMarketDataFields(sub.fields());
    }
