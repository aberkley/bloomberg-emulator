...
public class RandomDataGenerator
{
	...
	public static Object referenceDataFromFieldName(String fieldName, String security, boolean isOption, sra_london.bloomberg_emulator.ReferenceRequest rreq) throws Exception
	{
    ...
    public static sra_london.bloomberg_emulator.IntradayBarTickDataType generateBarData(Datetime date)
    {
        ...
        sra_london.bloomberg_emulator.IntradayBarTickDataType result = new sra_london.bloomberg_emulator.IntradayBarTickDataType();
