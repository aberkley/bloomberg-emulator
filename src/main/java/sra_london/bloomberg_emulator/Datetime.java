...
{	
	...
	public String toString()
	{
		...
		{
			case date:
				result = sra_london.bloomberg_emulator.DisplayFormats.FormatDate(this);
				break;
			case time:
				result = sra_london.bloomberg_emulator.DisplayFormats.FormatTimeZone(this);
				break;
			case both:
				result = sra_london.bloomberg_emulator.DisplayFormats.FormatDatetimeZone(this);
				break;
			case neither:
			default:
