...
public class HistoricRequest extends Request
{
    ...
    public void set(String name, String elementValue) throws Exception
    {
    	...
    	{
    		Datetime dtStart = sra_london.bloomberg_emulator.DisplayFormats.HistRef_TryParseInput(elementValue);
    		if(dtStart == null)
    	...
    	{
    		Datetime dtEnd = sra_london.bloomberg_emulator.DisplayFormats.HistRef_TryParseInput(elementValue);
    		if(dtEnd == null)
